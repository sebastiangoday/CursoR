...
El presente trabajo constituye la entrega final correspondiente al curso de R dictado por el profesor Carlos Gil, en el marco del Máster en Big Data y Analytics de la EAE Business School, edición 2019-2020.
...
5. Creación de gráficas dinámicas con ```plotly```
...
#### Ingresos vs Graduados de secundaria (facet_wrap + theme_economist)
